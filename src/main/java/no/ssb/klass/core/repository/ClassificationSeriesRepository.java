...
@Repository
public interface ClassificationSeriesRepository extends JpaRepository<ClassificationSeries, Long>,
    ...
    @Query(value = "select distinct classification.contactPerson.section from ClassificationSeries classification")
    Set<String> findAllResponsibleSections();

    @Query(value = "select distinct classification.contactPerson.section from ClassificationSeries as classification "
