...
public interface ClassificationService {
    ...
    List<Code> findClassificationCodes(Long id, DateRange dateRange, Language language);

    List<Code> findVariantClassificationCodes(Long id, String variantName, Language language, DateRange dateRange);

    List<Correspondence> findCorrespondences(Long sourceClassificationId, Long targetClassificationId,
