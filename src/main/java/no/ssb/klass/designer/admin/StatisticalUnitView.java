...
import no.ssb.klass.core.service.dto.StatisticalUnitDtoImpl;
...
public class StatisticalUnitView extends StatisticalUnitDesign {
    ...
    private void printRow(UsageStatisticsData usageStatisticsData) {
        ...
        StatisticalUnit statisticalUnit = ((StatisticalUnitDtoImpl)usageStatisticsData.getLine()).getStatisticalUnit();
    ...
    private UsageStatisticsData getReportData() {
        return statisticsService.getStaticalUnitsOverView(new PageRequest(0, Integer.MAX_VALUE));
    }
    ...
    private InputStream generateReport(StatisticalUnit statisticalUnit) {
        ...
        ClassificationReportData<ClassificationReportDto> classificationReport = 
                statisticsService.getAllClassificationSeriesForStaticalUnit(statisticalUnit);
    ...
    private void createDetailedReport(StatisticalUnit statisticalUnit) {
        ClassificationReportData<ClassificationReportDto> classifications = 
                statisticsService.getAllClassificationSeriesForStaticalUnit(statisticalUnit);
        mainView.classificationUnitReportView.makeDetailedReport(statisticalUnit, classifications, this);
