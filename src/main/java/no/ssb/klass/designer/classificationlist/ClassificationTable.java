...
import no.ssb.klass.designer.editing.ClassificationEditorView;
...
public class ClassificationTable extends AbstractTable {
    ...
    public void init(VersionTable versionTable, VariantTable variantTable) {
        ...
        filterBox = createFilterBox(table);
    ...
    private class ClassificationContainer extends AbstractPropertyContainer<ClassificationSeries> {
        ...
        protected void defineProperties() {
            ...
            addProperty(AbstractPropertyContainer.ENTITY, ClassificationSeries.class, null);
        ...
        protected void populateProperties(Item item, ClassificationSeries classification) {
            ...
            item.getItemProperty(AbstractPropertyContainer.NAME).setValue(classification.getNameInPrimaryLanguage());
            item.getItemProperty(AbstractPropertyContainer.OPEN).setValue(createViewButton(classification));
            item.getItemProperty(AbstractPropertyContainer.DELETE).setValue(createDeleteButton(classification));
            item.getItemProperty(AbstractPropertyContainer.ENTITY).setValue(classification);
        }
