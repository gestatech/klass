...
import no.ssb.klass.designer.editing.EditCorrespondenceTableView;
import no.ssb.klass.designer.editing.EditVariantEditorView;
...
public class VariantTable extends AbstractTable {
    ...
    private static class VariantContainer extends AbstractPropertyContainer<ClassificationEntityOperations> {
        ...
        protected void defineProperties() {
            ...
            addProperty(AbstractPropertyContainer.ENTITY, BaseEntity.class, null);
        ...
        protected void populateProperties(Item item, ClassificationEntityOperations entity) {
            item.getItemProperty(AbstractPropertyContainer.NAME).setValue(entity.getNameInPrimaryLanguage());
            item.getItemProperty(AbstractPropertyContainer.OPEN).setValue(createViewButton(entity));
            item.getItemProperty(AbstractPropertyContainer.DELETE).setValue(createDeleteButton(entity));
            item.getItemProperty(AbstractPropertyContainer.ENTITY).setValue(entity);
        }
