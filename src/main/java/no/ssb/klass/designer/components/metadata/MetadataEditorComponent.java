...
import no.ssb.klass.designer.editing.PublicationChoiceEditor;
...
public class MetadataEditorComponent extends CustomComponent implements HasEditingState {
    ...
    public MetadataEditorComponent() {
        ...
        design.languageSelect.addEditLanguagesListener(isEditMode -> showOtherLanguages(isEditMode));
        design.languageSelect.addLanguageChangeListener(newLanguage -> updateLanguagePanels(newLanguage));
    ...
    public void configureContactPersonCombobox() {
        ...
        design.contactPersonCombobox.addValueChangeListener(event -> updateSection(event));
    }
