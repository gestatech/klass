...
public class CreateVersionView extends VerticalLayout implements EditingView {
    ...
    public static final String COPY_LAST_VERSION_KEY = "copyLastVersion";
    ...
    public void enter(ViewChangeEvent event) {
        DateRange dateRange = ParameterUtil.getRequiredDataRange(VALID_FROM_KEY, VALID_TO_KEY, event.getParameters());
    ...
    private ClassificationSeries getClassificationSeries(String parametersString) {
        ...
        ClassificationSeries classificationSeries = classificationFacade.getRequiredClassificationSeries(
                classificationId);
