...
public class CorrespondenceItem implements Comparable<CorrespondenceItem> {
    ...
    public CorrespondenceItem(Correspondence correspondence) {
    ...
    public static class RangedCorrespondenceItem extends CorrespondenceItem {
        ...
        public RangedCorrespondenceItem(Correspondence correspondence) {
            super(correspondence);
            this.validRange = checkNotNull(correspondence.getValidRange());
        }
