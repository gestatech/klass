...
public class ClassificationResource extends ClassificationSummaryResource {
    ...
    private Link createVariantAtRelation(Long id) {
        ControllerLinkBuilder linkBuilder = linkTo(methodOn(ClassificationController.class).variantAt(id, "name",
                LocalDate.now(), ",", "level", "selectCodes", "presentationNamePattern", Language.getDefault()));
    ...
    private Link createVariantRelation(Long id) {
        ControllerLinkBuilder linkBuilder = linkTo(methodOn(ClassificationController.class).variant(id, "name",
    ...
    private Link createCodesAtRelation(Long id) {
        ControllerLinkBuilder linkBuilder = linkTo(methodOn(ClassificationController.class).codesAt(id, LocalDate.now(),
                ",", "level", "selectCodes", "presentationNamePattern", Language.getDefault()));
    ...
    private Link createCodesRelation(Long id) {
        ControllerLinkBuilder linkBuilder = linkTo(methodOn(ClassificationController.class).codes(id, LocalDate.now(),
                LocalDate.now(), ",", "level", "selectCodes", "presentationNamePattern", Language.getDefault()));
    ...
    private Link createChangesRelation(Long id) {
        ControllerLinkBuilder linkBuilder = linkTo(methodOn(ClassificationController.class).changes(id, LocalDate.now(),
                LocalDate.now(), ",", Language.getDefault()));
    ...
    private Link createCorrespondsAtRelation(Long id) {
        ControllerLinkBuilder linkBuilder = linkTo(methodOn(ClassificationController.class).correspondsAt(id, 2L,
                LocalDate.now(), ",", Language.getDefault()));
    ...
    private Link createCorrespondsRelation(Long id) {
        ControllerLinkBuilder linkBuilder = linkTo(methodOn(ClassificationController.class).corresponds(id, 2L,
                LocalDate.now(), LocalDate.now(), ",", Language.getDefault()));
