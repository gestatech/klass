...
public class ClassificationSeriesTest {
    ...
    public void getChangeTables() {
        ...
        // when
        List<CorrespondenceTable> result = subject.getChangeTables(DateRange.create(start, start.plusYears(4)));
    ...
    public void getChangeTableNotFound() {
        ...
        // when
        subject.getChangeTables(DateRange.create(start, start.plusYears(4)));
