...
public class ClassificationVersionTest {
    ...
    public void findVariant() {
        ...
        // when
        ClassificationVariant result = subject.findVariant(variantName, Language.NB);

        // then
        assertEquals(variantName, result.getName(Language.NB));
    }
    ...
    public void findVariantFiltersDeleted() {
        ...
        // when
        subject.findVariant(variantName, Language.NB);
    ...
    public void findVariantNotFound() {
        ...
        // when
        subject.findVariant("unknown", Language.NB);
    ...
    public void getNameInPrimaryLanguage() {
        ...
        assertEquals("Test 02-2016", classificationVersion1.getNameInPrimaryLanguage());
        assertEquals("Test 2015", classificationVersion2.getNameInPrimaryLanguage());
        assertEquals("Test 07-2016", classificationVersion3.getNameInPrimaryLanguage());
        assertEquals("Test 03-2017", classificationVersion4.getNameInPrimaryLanguage());
        assertEquals("Test 11-2016", classificationVersion5.getNameInPrimaryLanguage());
    }
