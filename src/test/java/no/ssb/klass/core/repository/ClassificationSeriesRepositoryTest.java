...
public class ClassificationSeriesRepositoryTest {
    ...
    public void verifyMapping() {
        ...
        classificationFamilyRepository.save(TestUtil.createClassificationFamily("family")).addClassificationSeries(
                classification);
    ...
    public void findAllCodelist() {
        ...
        ClassificationSeriesSpecification includeCodelistsSpecification = new ClassificationSeriesSpecification(true,
                null);
        ClassificationSeriesSpecification excludeCodelistsSpecification = new ClassificationSeriesSpecification(false,
                null);
    ...
    public void findAllChangedSince() throws Exception {
        ...
        ClassificationSeriesSpecification beforeCreatedSpecification = new ClassificationSeriesSpecification(true,
                beforeCreated);
        ClassificationSeriesSpecification afterCreatedSpecification = new ClassificationSeriesSpecification(true,
                afterCreated);
    ...
    public void testNumberOfClassifications() {
        ...
        result = subject.findNumberOfPublishedClassifications(ClassificationType.CLASSIFICATION, user.getSection());
        assertEquals(2, result);
    ...
    public void testNumberOfVersions() {
        ...
        assertEquals(0, result);
        result = subject.findNumberOfPublishedVersionsAllLanguages(ClassificationType.CODELIST, user.getSection());
        assertEquals(0, result);
        ...
        assertEquals(0, result);
        result = subject.findNumberOfPublishedVersionsAnyLanguages(ClassificationType.CODELIST, user.getSection());
        assertEquals(0, result);
    ...
    public void testClassificationsReport() {
        ...
        List<ClassificationReportDto> list = subject.getClassificationReport(ClassificationType.CLASSIFICATION, user
                .getSection());
        assertEquals(2, list.size());
        ClassificationReportData<ClassificationReportDto> wrapper =
                new ClassificationReportData<>(list);
        assertEquals(
                "section\tDuppeditt\tKlassifikasjon\tZiggy Stardust\t\nsection\tDingseboms\tKlassifikasjon\tZiggy Stardust\t\n",
        ...
        assertEquals(
                "section\tDuppeditt\tKlassifikasjon\tZiggy Stardust\t\nsection\tDingseboms\tKlassifikasjon\tZiggy Stardust\t\n",
                wrapper.exportToExcel('\t'));
        list = subject.getClassificationReport(ClassificationType.CODELIST, user.getSection());
        assertEquals(0, list.size());
        list = subject.getClassificationReport(ClassificationType.CLASSIFICATION, "007");
        assertEquals(0, list.size());
    ...
    public void testPublishedClassificationReport() {
        ...
        List<ClassificationReportDto> list = subject.getPublishedClassificationReport(ClassificationType.CLASSIFICATION,
                user
                        .getSection());
        assertEquals(2, list.size());
        ClassificationReportData<ClassificationReportDto> wrapper =
        ...
        wrapper = new ClassificationReportData<>(list);
        assertEquals("section\tDuppeditt\tKlassifikasjon\tZiggy Stardust\t\n", wrapper.exportToExcel('\t'));
        list = subject.getPublishedClassificationReport(ClassificationType.CODELIST, user.getSection());
        assertEquals(0, list.size());
        list = subject.getPublishedClassificationReport(ClassificationType.CLASSIFICATION, "007");
        assertEquals(0, list.size());
    ...
    public void testPublishedVersionsAnyLanguages() {
        ...
        List<ClassificationVersionReportDto> list = subject.getPublishedVersionsAnyLanguages(
                ClassificationType.CLASSIFICATION, user
                        .getSection());
        assertEquals(2, list.size());
        ...
        wrapper = new ClassificationReportData<>(list);
        assertEquals("section\tDuppeditt\tKlassifikasjon\tZiggy Stardust\t\n", wrapper.exportToExcel('\t'));
        list = subject.getPublishedVersionsAnyLanguages(ClassificationType.CODELIST, user.getSection());
        assertEquals(0, list.size());
        list = subject.getPublishedVersionsAnyLanguages(ClassificationType.CLASSIFICATION, "007");
        assertEquals(0, list.size());
    ...
    public void testPublishedVersionsAllLanguages() {
        ...
        List<ClassificationVersionReportDto> list = subject.getPublishedVersionsAllLanguages(
                ClassificationType.CLASSIFICATION, user
                        .getSection());
        assertEquals(0, list.size());
        ...
        list = subject.getPublishedVersionsAllLanguages(ClassificationType.CLASSIFICATION, user.getSection());
        assertEquals(2, list.size());
        ClassificationReportData<ClassificationVersionReportDto> wrapper =
                new ClassificationReportData<>(list);
        assertEquals(
        ...
        wrapper = new ClassificationReportData<>(list);
        assertEquals("section\tDuppeditt\tKlassifikasjon\tZiggy Stardust\t\n", wrapper.exportToExcel('\t'));
        list = subject.getPublishedVersionsAllLanguages(ClassificationType.CODELIST, user.getSection());
        assertEquals(0, list.size());
        list = subject.getPublishedVersionsAllLanguages(ClassificationType.CLASSIFICATION, "007");
        assertEquals(0, list.size());
    ...
    public void getNumberOfClassificationForUserAndUpdateUserTest() {
        ...
        classificationFamilyRepository.save(TestUtil.createClassificationFamily("name2")).addClassificationSeries(
                classification2);
        classificationFamilyRepository.save(TestUtil.createClassificationFamily("name3")).addClassificationSeries(
                classification3);
        subject.save(classification);
        subject.save(classification2);
    ...
    public static ClassificationSeries createClassificationSeriesWithVersion(User user, String classificationName) {
        ...
        version.addClassificationItem(TestUtil.createClassificationItem("0001", "firstItem"), level.getLevelNumber(),
                null);
        version.addClassificationItem(TestUtil.createClassificationItem("0002", "secondItem"), level.getLevelNumber(),
                null);
