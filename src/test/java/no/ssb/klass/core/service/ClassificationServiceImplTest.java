...
public class ClassificationServiceImplTest {
    ...
    public void getClassificationVersionFiltersDeleted() {
        // given
        final Long id = 1L;
        ClassificationVersion version = TestUtil.createClassificationVersionWithId(id,
                TestUtil.anyDateRange());
        version.setDeleted();
        when(classificationVersionRepositoryMock.findOne(id)).thenReturn(version);
    ...
    public void findReferencesOfClassificationItemReferencingItem() {
        ...
        when(referencingClassificationItemRepositoryMock.findByReference(any())).thenReturn(
    ...
    public void findReferencesOfClassificationItemWithCorrespondenceMapSource() {
        ...
        when(correspondenceMapRepositoryMock.findBySource(any(ClassificationItem.class))).thenReturn(Lists.newArrayList(
                map));
    ...
    public void findReferencesOfClassificationItemWithCorrespondenceMapTarget() {
        ...
        when(correspondenceMapRepositoryMock.findByTarget(any(ClassificationItem.class))).thenReturn(Lists.newArrayList(
                map));
