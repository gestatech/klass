...
import no.ssb.klass.core.service.dto.AccessCounterDtoImpl;
...
public class StatisticsServiceImplTest {
    ...
    public void setup() {
        ...
        classificationAccessCounterRepositoryMock = mock(ClassificationAccessRepository.class);
        statisticalUnitRepositoryMock = mock(StatisticalUnitRepository.class);

        subject = new StatisticsServiceImpl(classificationSeriesRepositoryMock,
                classificationAccessCounterRepositoryMock, searchWordsRepositoryMock, statisticalUnitRepositoryMock);
    }
    ...
    public void testGenerateContentUseStat() {
        ...
        when(classificationSeriesRepositoryMock.findNumberOfPublishedVersionsAllLanguages(any(ClassificationType.class),
                anyString()))
                        .thenReturn(55);
        ContentUseStatisticRows res = subject.generateContentUseStat(section, ClassificationType.CLASSIFICATION);
        ...
        verify(classificationSeriesRepositoryMock, times(1)).findNumberOfPublishedClassifications(
                eq(ClassificationType.CLASSIFICATION), eq(section));
        verify(classificationSeriesRepositoryMock, times(1)).findNumberOfPublishedVersionsAnyLanguages(
                eq(ClassificationType.CLASSIFICATION), eq(section));
        verify(classificationSeriesRepositoryMock, times(1)).findNumberOfPublishedVersionsAllLanguages(
                eq(ClassificationType.CLASSIFICATION), eq(section));
    }
    ...
    public void testClassificationReportTotal() {
        String section = "007";
        List<ClassificationReportDto> mockResult = makeClassificationData("A", "AllClassifications"); 
        when(classificationSeriesRepositoryMock.getClassificationReport(any(ClassificationType.class), anyString()))
                .thenReturn(mockResult);
        ClassificationReportData<?> result = subject.getClassificationReport(section, ClassificationType.CLASSIFICATION,
    ...
    public void testClassificationReportDataPublished() {
        String section = "007";
        List<ClassificationReportDto> mockResult = makeClassificationData("B", "PublishedAllClassifications");
    ...
    public void testClassificationReportDataUnPublished() {
        ...
        List<ClassificationReportDto> published = makeClassificationData13("B", "PublishedAllClassifications");
        when(classificationSeriesRepositoryMock.getClassificationReport(any(ClassificationType.class), anyString()))
                .thenReturn(all);
        when(classificationSeriesRepositoryMock.getPublishedClassificationReport(any(ClassificationType.class),
    ...
    public void testVersionReportMissingLanguages() {
        String section = "007";
        List<ClassificationVersionReportDto> all = makeClassificationVersionData("A", "AllClassifications");
        List<ClassificationVersionReportDto> published = makeClassificationVersionData1("A", "AllClassifications");
        ...
        VersionReportData result = (VersionReportData) subject
                .getClassificationReport(section, ClassificationType.CLASSIFICATION, ReportModeChoice.MISSING_LANG);
        checkVersionReportData(result, "A");
    }

    @Test
    public void testGetUsageStatistics() {
        when(classificationAccessCounterRepositoryMock.getAccessSum(any(Date.class), any(Date.class))).thenReturn(42);
        when(searchWordsRepositoryMock.getNumberOfSearchWords(any(Date.class), any(Date.class))).thenReturn(55);
        when(searchWordsRepositoryMock.getNumberOfMiss(any(Date.class), any(Date.class))).thenReturn(25);
        Map<ReportDescription<UseStatisticsModeChoice>, Integer> result = subject.getUsageStatistics(getFromDate(), getToDate()).getRows();
        assertEquals(Integer.valueOf(42), result.get(UseStatisticsModeChoice.TOTAL_CLASSIFIC));
        assertEquals(Integer.valueOf(55), result.get(UseStatisticsModeChoice.TOTAL_SEARCH_WORDS));
        assertEquals(Integer.valueOf(25), result.get(UseStatisticsModeChoice.NUMBEROF_SEARCH_RETURNED_NULL));                
    }
    
    @Test
    public void testGetUsageStatisticsClassification() {
        when(classificationAccessCounterRepositoryMock.getClassificationsCount(any(Date.class), any(Date.class), any(PageRequest.class)))
        .thenReturn(makeTestData());
        UsageStatisticsData result = subject.getUsageStatistics(getFromDate(), getToDate(), UseStatisticsModeChoice.TOTAL_CLASSIFIC, 
    ...
    public void testGetUsageStatisticsSearchReturnedNull() {
        when(searchWordsRepositoryMock.getSearchWords(anyBoolean(), any(Date.class), any(Date.class), any(PageRequest.class)))
        .thenReturn(makeTestData());
        UsageStatisticsData result = subject.getUsageStatistics(getFromDate(), getToDate(), UseStatisticsModeChoice.NUMBEROF_SEARCH_RETURNED_NULL, 
                new PageRequest(0, Integer.MAX_VALUE));
        checkResult(result);
    }
    ...
    public void testGetUsageStatisticsTotalSearchWords() {
        when(searchWordsRepositoryMock.getSearchWords(any(Date.class), any(Date.class), any(PageRequest.class))).thenReturn(makeTestData());
        UsageStatisticsData result = subject.getUsageStatistics(getFromDate(), getToDate(), UseStatisticsModeChoice.TOTAL_SEARCH_WORDS, 
                new PageRequest(0, Integer.MAX_VALUE));
        checkResult(result);
    }
    ...
    public void testGetAllClassificationSeriesForStaticalUnit() {
        ...
        when(statisticalUnitRepositoryMock.getAllClassificationSeriesForStaticalUnit(any(StatisticalUnit.class))).thenReturn(generatedResult);
        ClassificationReportData<ClassificationReportDto> result = subject.getAllClassificationSeriesForStaticalUnit(statisticalUnit);
        assertEquals("S1;C1;Klassifikasjon;Donald;\nS1;C4;Klassifikasjon;Donald;\nS2;C2;Klassifikasjon;Donald;\nS2;C3;Klassifikasjon;Donald;\n", 
                result.exportToExcel(';'));
    }
    
    private Page<StatisticalEntity> makeTestData() {
        AccessCounterDtoImpl data1 = new AccessCounterDtoImpl("A", 1L);
        AccessCounterDtoImpl data2 = new AccessCounterDtoImpl("B", 2L);
        AccessCounterDtoImpl data3 = new AccessCounterDtoImpl("C", 3L);
    ...
    private void checkClassificationReportData(ClassificationReportData<?> result, String section, String name) {
        result.reset();
        assertEquals(section + '1', result.getSection());
        assertEquals(name + "1_NO", result.getName());
        assertEquals(ClassificationType.CLASSIFICATION.getDisplayName(Language.NB), result.getType());
    ...
    private void checkClassificationReportDataNotPub(ClassificationReportData<?> result, String section, String name) {
        result.reset();
        assertEquals(section + '1', result.getSection());
        assertEquals(name + "2_NO", result.getName());
        assertEquals(ClassificationType.CLASSIFICATION.getDisplayName(Language.NB), result.getType());
    ...
    private List<ClassificationReportDto> makeClassificationData(String section, String name) {
        ...
        result.add(new ClassificationReportDto(mockClassificationSeries(2L, name + "2_NO"), mockUser(section + '1', "Skrue")));
        result.add(new ClassificationReportDto(mockClassificationSeries(1L, name + "1_NO"), mockUser(section + '1', "Donald")));        
        result.add(new ClassificationReportDto(mockClassificationSeries(3L, name + "3_NO"), mockUser(section + '2', "Skrue")));
        return result;
    }
    
    private List<ClassificationReportDto> makeClassificationData13(String section, String name) {
        List<ClassificationReportDto> result = new ArrayList<>(3);
        result.add(new ClassificationReportDto(mockClassificationSeries(1L, name + "1_NO"), mockUser(section + '1', "Donald")));        
        result.add(new ClassificationReportDto(mockClassificationSeries(3L, name + "3_NO"), mockUser(section + '2', "Skrue")));
        return result;
    ...
    private List<ClassificationVersionReportDto> makeClassificationVersionData(String section, String name) {
        List<ClassificationVersionReportDto> result = new ArrayList<>(3);
        result.add(new ClassificationVersionReportDto(mockClassificationVersion("A", true, true, true), 
                mockClassificationSeries(1L, name + "1_NO"), mockUser(section + '1', "Donald")));
        result.add(new ClassificationVersionReportDto(mockClassificationVersion("B", false, true, false), 
                mockClassificationSeries(2L, name + "2_NO"), mockUser(section + '1', "Skrue")));
        result.add(new ClassificationVersionReportDto(mockClassificationVersion("C", true, false, true), 
                mockClassificationSeries(3L, name + "3_NO"), mockUser(section + '2', "Skrue")));
        return result;
    }
    
    private List<ClassificationVersionReportDto> makeClassificationVersionData1(String section, String name) {
        List<ClassificationVersionReportDto> result = new ArrayList<>(3);
        result.add(new ClassificationVersionReportDto(mockClassificationVersion("A", true, true, true), 
                mockClassificationSeries(1L, name + "1_NO"), mockUser(section + '1', "Donald")));
        return result;
    ...
    private ClassificationVersion mockClassificationVersion(String name, boolean pubNo, boolean pubNn, boolean pubEn) {
