...
public class ClassificationVariantTestBench extends AbstractTestBench {
    ...
    private void testDeleteVariant(ClassificationListPage classificationListPage) {
        ...
        classificationListPage.deleteVariant(VARIANT_NAME);
    ...
    private void testEditVariantCodes(ClassificationListPage classificationListPage) {
        ...
        variantCodesPage = classificationListPage.openVariant(VARIANT_NAME).selectCodesTab(
        ...
        assertEquals(3, variantCodesPage.countRowsInVariant()); // Including new code editor
    ...
    private void testEditVariantMetadata(ClassificationListPage classificationListPage) {
        ...
        // Cancel when no changes
        classificationListPage.openVariant(VARIANT_NAME).clickAvbryt();

        // Cancel when updated metadata
        correspondenceTableMetadataPage = classificationListPage.openVariant(VARIANT_NAME).selectMetadataTab(
