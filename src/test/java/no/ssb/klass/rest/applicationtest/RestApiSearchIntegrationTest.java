...
//                .prettyPeek()
                ...
                .body(JSON_SEARCH_RESULT1 + ".searchScore", greaterThan(0))
                ...
                .body(JSON_SEARCH_RESULT2 + ".searchScore", greaterThan(0))
...
//                .prettyPeek()
                ...
                .body(XML_SEARCH_RESULT1 + ".searchScore.toInteger()", greaterThan(0))
                ...
                .body(XML_SEARCH_RESULT2 + ".searchScore.toInteger();", greaterThan(0))
